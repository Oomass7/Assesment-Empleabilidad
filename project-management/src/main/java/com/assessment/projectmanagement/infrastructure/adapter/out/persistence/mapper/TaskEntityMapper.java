...
public class TaskEntityMapper {
        ...
        public Task toDomain(TaskEntity entity) {
                ...
                return Task.builder()
                                ...
                                .project(entity.getProject() != null
                                                ? com.assessment.projectmanagement.domain.model.Project.builder()
                                                                ...
                                                                .owner(entity.getProject().getOwner() != null
                                                                                ? com.assessment.projectmanagement.domain.model.User
                                                                                                .builder()
                                                                                                .id(entity.getProject()
                                                                                                                .getOwner()
                                                                                                                .getId())
                                                                                                .email(entity.getProject()
                                                                                                                .getOwner()
                                                                                                                .getEmail())
                                                                                                .username(entity.getProject()
                                                                                                                .getOwner()
                                                                                                                .getUsername())
                                                                                                .build()
                                                                                : null)
